...
async function main() {
    // Generate CRS phase 1 (i.e., Powers of Tau Ceremony)
    {
        ...
        const param3 = `./powers-of-tau/pot${max_constraint}_00.ptau`;
        printConsoleLog(
    ...
    {
        {
            const param1 = `./powers-of-tau/pot${max_constraint}_00.ptau`;
            const param2 = `./powers-of-tau/pot${max_constraint}_01.ptau`;
        ...
        {
            const param1 = `./powers-of-tau/pot${max_constraint}_01.ptau`;
            const param2 = `./powers-of-tau/pot${max_constraint}_02.ptau`;
            const param3 = await randomByteString(entropy_length);
        ...
        {
            const param1 = `./powers-of-tau/pot${max_constraint}_02.ptau`;
            const param2 = `./powers-of-tau/pot${max_constraint}_03.ptau`;
            const param3 = await randomByteString(entropy_length);
    ...
    {
        {
            const param1 = `./powers-of-tau/pot${max_constraint}_03.ptau`;
            const param2 = `./powers-of-tau/pot${max_constraint}_beacon.ptau`;
            const param3 = await randomByteString(entropy_length);
        ...
        {
            const param1 = `./powers-of-tau/pot${max_constraint}_beacon.ptau`;
            const param2 = `./powers-of-tau/pot${max_constraint}_final.ptau`;
            printConsoleLog(
    ...
    // Verify CRS
    {
        const param1 = `./powers-of-tau/pot${max_constraint}_final.ptau`;
        printConsoleLog(
